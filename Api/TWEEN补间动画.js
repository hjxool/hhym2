...
var Easing = Object.freeze({
	...
	Elastic: Object.freeze({
		...
		InOut: function(amount) {
			...
			amount *= 2;
			if (amount < 1) {
				return -0.5 * Math.pow(2, 10 * (amount - 1)) * Math.sin((amount - 1.1) * 5 * Math
					.PI);
			}
	...
	Group.prototype.onComplete = function(callback) {
		...
		group.forEach(function(tween) {
			...
			tween.onComplete(function() {
				prevCallback === null || prevCallback === void 0 ? void 0 : prevCallback(
					tween);
...
var Tween = /** @class */ (function() {
	...
	Tween.prototype._setupProperties = function(_object, _valuesStart, _valuesEnd, _valuesStartRepeat,
		...
		for (var property in _valuesEnd) {
			...
			if ((propType === 'object' || startValueIsArray) && startValue && !isInterpolationList) {
				...
				this._setupProperties(nestedObject, _valuesStart[property], endValues, _valuesStartRepeat[
					property], overrideStartingValues);
			} else {
	...
	Tween.prototype.update = function(time, autoStart) {
		...
		var durationAndDelay = this._duration + ((_a = this._repeatDelayTime) !== null && _a !== void 0 ?
			_a : this._delayTime);
		...
		if (this._duration === 0 || elapsedTime >= this._duration) {
			if (this._repeat > 0) {
				var completeCount = Math.min(Math.trunc((elapsedTime - this._duration) / durationAndDelay) +
					1, this._repeat);
